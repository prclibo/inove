	...
	<div class="widget widget_feeds">
		<div class="content clearfix">
			<div id="subscribe">
				...
				<?php if($options['feed_readers']) : ?>
					<ul id="feed_readers">
						...
						<li id="youdao_reader"><a rel="external nofollow" class="reader" title="<?php _e('Subscribe with ', 'inove'); _e('Youdao', 'inove'); ?>" href="http://reader.youdao.com/b.do?url=<?php echo $feed; ?>"><span><?php _e('Youdao', 'inove'); ?></span></a></li>
						...
						<li id="douban_reader"><a rel="external nofollow" class="reader" title="<?php _e('Subscribe with ', 'inove'); _e('Douban', 'inove'); ?>" href="http://9.douban.com/reader/subscribe?url=<?php echo $feed; ?>"><span><?php _e('Douban', 'inove'); ?></span></a></li>
						<li id="qq_reader"><a rel="external nofollow" class="reader" title="<?php _e('Subscribe with ', 'inove'); _e('QQ Mail', 'inove'); ?>" href="http://mail.qq.com/cgi-bin/feed?u=<?php echo $feed; ?>"><span><?php _e('QQ Mail', 'inove'); ?></span></a></li>
						<li id="yahoo_reader"><a rel="external nofollow" class="reader" title="<?php _e('Subscribe with ', 'inove'); _e('QQ Mail', 'inove'); ?>" href="http://add.my.yahoo.com/rss?url=<?php echo $feed; ?>"><span><?php _e('My Yahoo!', 'inove'); ?></span></a></li>
			...
			<?php endif; if($options['twitter'] && $options['twitter_username']) : ?>
				<a rel="external nofollow" id="followme" title="<?php _e('Follow me!', 'inove'); ?>" href="https://twitter.com/<?php echo $options['twitter_username']; ?>/"><?php _e('Twitter', 'inove'); ?></a>
			<?php endif; ?>
		</div>
	</div>
...
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('north_sidebar') ) : ?>
	...
	<?php if( function_exists('wp_recentcomments') ) : ?>
		<div class="widget">
			...
			<ul>
				<?php wp_recentcomments('limit=5&length=14&post=false&smilies=true'); ?>
			</ul>
		</div>
	<?php endif; ?>
...
<div id="centersidebar" class="clearfix">
